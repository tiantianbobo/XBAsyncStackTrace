...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/tiantianbobo/XBAsyncStackTrace.git" }
  s.static_framework = true
  # s.source       = { :git => "https://github.com/tiantianbobo/AsyncStackTrace.git", :tag => "#{s.version}" }
